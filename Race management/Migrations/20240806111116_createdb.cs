    ...
    public partial class createdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShowToCoach", x => new { x.ShowId, x.Coachid });
                    table.ForeignKey(
                        name: "FK_ShowToCoach_AspNetUsers_Coachid",
                        column: x => x.Coachid,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShowToCoach_Shows_ShowId",
                        column: x => x.ShowId,
